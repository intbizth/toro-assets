+function ($) {
    ...
    Widget.prototype.isLoaded = function () {
        return this.$element.hasClass('wg-dos--loaded');
    };
    ...
    Widget.prototype.load = function (opt) {
        ...
        var success = opt.success || function (response) {
                ...
                var $content = me.$element.find('.wg-container').html();
                ...
                me.$element = $response;
                me.$element.addClass('wg-dos--loaded');

                if(!me.$element.is(":visible")){
                    me.$element.fadeIn();
                }

                Plugin.call(me.$element);
        ...
        var error = opt.error || function () {
                this.mask('hide');
                me.$element.replaceWith('<div class="wg-error">Error!</div>');
            };

        this.$element.removeClass('wg-dos--loaded');
